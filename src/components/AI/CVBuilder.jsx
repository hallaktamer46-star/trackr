...
const S = {
  label: {
    fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 9, fontWeight: 600,
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 8 }}>
        {tags.map(t => (
          <span key={t} style={{
            ...
            color: '#a3c9ff', fontSize: 11, fontFamily: 'Consolas, Menlo, Monaco, monospace',
            padding: '3px 10px',
          }}>
            {t}
    ...
    <div>
      {list.map((exp, i) => (
        <div key={i} style={S.card}>
          ...
          <p style={{ fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 9, color: '#404753', marginBottom: 8 }}>
          ...
          <button onClick={() => addBullet(i)} style={{
            ...
            color: '#404753', fontSize: 11, fontFamily: 'Consolas, Menlo, Monaco, monospace',
      ...
      <button onClick={() => setList([...list, emptyExp()])} style={{
        ...
        color: '#ffb689', fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 11, fontWeight: 600,
  ...
  return (
    <div>
      ...
      <button onClick={() => setList([...list, emptyEdu()])} style={{
        ...
        color: '#4edea3', fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 11, fontWeight: 600,
        letterSpacing: '0.06em', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
      }}>
    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div>
          ...
          <p style={{ fontSize: 11, color: '#8a919f', fontFamily: 'Consolas, Menlo, Monaco, monospace' }}>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button onClick={copy} style={{
            ...
            fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 11, fontWeight: 600, letterSpacing: '0.05em',
          }}>
      ...
      <p style={{ fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 10, color: '#404753', marginTop: 12, textAlign: 'center' }}>
...
export default function CVBuilder() {
  ...
  return (
    <div style={{ fontFamily: 'Geist, Inter, sans-serif' }}>
        ...
        {STEPS.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <span style={{
                fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 10, fontWeight: 700, letterSpacing: '0.06em',
      ...
      {error && (
        <p style={{ fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 11, color: '#ffb4ab', marginTop: 12 }}>{error}</p>
      )}
        ...
        {step < STEPS.length - 1 ? (
          <button
            ...
            style={{
              ...
              fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 11, fontWeight: 700, letterSpacing: '0.08em',
              textTransform: 'uppercase',
            }}
          >
