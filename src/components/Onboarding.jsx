        ...
        {step === 1 && (
          <div>
            ...
            <div className="space-y-3">
              <div>
                <label style={{ fontFamily: 'Consolas, Menlo, Monaco, monospace', fontSize: 9, fontWeight: 600, letterSpacing: '0.1em', color: '#8a919f', textTransform: 'uppercase', display: 'block', marginBottom: 6 }}>
                  First name
                </label>
                <input
                  autoFocus
