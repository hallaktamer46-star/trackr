        ...
        <div>
          ...
          <div style={{ marginBottom:32 }}>
            ...
            <p style={{ fontSize:12, color:'rgba(163,201,255,0.45)', marginTop:8, fontFamily:SANS }}>
              {today()} · Just talk. 2 minutes. AI does the rest.
            </p>
          </div>
            ...
            <div style={{ animation:'db-in .3s ease' }}>
              ...
              <div style={{
                ...
                <textarea
                  ...
                  placeholder="Just start talking — what happened today? What felt hard? What felt good? What are you putting off? Don't filter it."
                  style={{
