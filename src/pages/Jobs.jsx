...
function SectionHeader({ label, color, count, icon: Icon }) {
  return (
    <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:8 }}>
      ...
      <span style={{ fontFamily:'Consolas, Menlo, Monaco, monospace', fontSize:9, fontWeight:700, letterSpacing:'0.15em', textTransform:'uppercase', color }}>{label}</span>
      <div style={{ flex:1, height:'0.5px', background:`linear-gradient(90deg, ${color}40, transparent)` }}/>
      <span style={{ fontFamily:'Consolas, Menlo, Monaco, monospace', fontSize:9, color:'#404753' }}>{count}</span>
    </div>
  )
}
