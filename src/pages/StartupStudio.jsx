...
const GLOBAL_CSS = `
  ...
  .ss-pill {
    ...
    font-family: Consolas, Menlo, Monaco, monospace; font-size: 11px; font-weight: 700;
  ...
  .ss-gen-btn {
    ...
    cursor: pointer; font-family: Consolas, Menlo, Monaco, monospace;
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 28, animation: 'ssFadeUp 0.5s ease' }}>
          ...
          <ResultSection title="Outreach Template" color="#34d399">
            <div style={{ position: 'relative' }}>
              <pre style={{ fontSize: 12, color: '#cbd5e1', lineHeight: 1.75, whiteSpace: 'pre-wrap', fontFamily: 'Consolas, Menlo, Monaco, monospace', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 8, padding: '12px 14px', margin: 0 }}>
