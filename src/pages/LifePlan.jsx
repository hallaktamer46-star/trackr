              ...
              {PRESETS.map(p => {
                ...
                return (
                  ...
                  >
                    ...
                    {used && <span style={{ fontSize:9, color:p.color, marginLeft:'auto', fontFamily:MONO }}>âœ“</span>}
                  </button>
                )
              })}
            </div>
